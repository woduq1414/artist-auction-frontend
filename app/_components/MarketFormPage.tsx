...
const MarketFormPage: React.FC<{
    ...
    category?: string, price?: number, duration?: number, mainImageList?: any[], exampleImageList?: any[],
    ...
    const [duration, setDuration] = useState<number>(props.duration || 7);
    const [durationError, setDurationError] = useState<any>('');

    const [mainImageList, setMainImageList] = useState<any[]>(props.mainImageList || []);
    ...
    useEffect(() => {
            ...
            import('preline/preline').then((module) => {
                ...
                for (let i = 0; i < categoryList.length; i++) {
                    for (let j = 0; j < categoryList[i].list.length; j++) {
                        if (categoryList[i].list[j].id.toString() === props.category) {
                            setFirstCategory(categoryList[i].id.toString());

                            const element = document.querySelector(`div.first-category-option[tabindex="${i}"]`) as HTMLDivElement;
                            // console.log(element, i);
                            element?.click();


                            setSubCategoryList(categoryList[i].list);
                            setSecondCategory(props.category);
        ...
        console.log(props.mainImageList, props.exampleImageList)
  ...
  "optionClasses": "first-category-option py-2 px-4 w-full text-sm text-gray-800 cursor-pointer hover:bg-gray-100 rounded-lg focus:outline-none focus:bg-gray-100 dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:text-neutral-200 dark:focus:bg-neutral-800",
  ...
  "extraMarkup": "<div class=\"absolute top-1/2 end-3 -translate-y-1/2\"><svg class=\"flex-shrink-0 size-3.5 text-gray-500 dark:text-neutral-500\" xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"m7 15 5 5 5-5\"/><path d=\"m7 9 5-5 5 5\"/></svg></div>"
                                            ...
                                            <select data-hs-select={JSON.stringify({
                                                ...
                                                "toggleClasses": "hs-select-disabled:pointer-events-none hs-select-disabled:opacity-50 relative py-3 px-4 pe-9 flex text-nowrap w-full cursor-pointer bg-white border border-gray-200 rounded-lg text-start text-sm focus:border-primary focus:ring-primary before:absolute before:inset-0 before:z-[1] dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400",
                                                "dropdownClasses": "mt-2 z-50 w-full max-h-72 p-1 space-y-0.5 bg-white border border-gray-200 rounded-lg overflow-hidden overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500 dark:bg-neutral-900 dark:border-neutral-700",
                                                "optionClasses": "second-category-option py-2 px-4 w-full text-sm text-gray-800 cursor-pointer hover:bg-gray-100 rounded-lg focus:outline-none focus:bg-gray-100 dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:text-neutral-200 dark:focus:bg-neutral-800",
                                                "optionTemplate": "<div class=\"flex justify-between items-center w-full\"><span data-title></span><span class=\"hidden hs-selected:block\"><svg class=\"flex-shrink-0 size-3.5 text-primary dark:text-primary\" xmlns=\"http:.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><polyline points=\"20 6 9 17 4 12\"/></svg></span></div>",
...

                                        {
                                            mainImageList.length >= 1 && (
                                                <div className='relative flex items-center justify-center bg-white shadow-md cursor-pointer hover:bg-gray-50 rounded-xl'>
                                                    <img src={mainImageList[0].url} alt="" className='object-cover h-[130px] w-fit rounded-xl' />
